<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Deposit_Bitcoin.aspx.vb" Inherits="Deposit_Bitcoin" %>
																	       ...
																	       <tr>
																	          <td align=center>
																	           ...
																	           <tr> 
																	               ...
																	               We will not refund an incorrect withdrawal or Deposit. Be sure you send BTC to the correct address.
																	              ...
																	              <tr> 
																	                <td align=center class=head07>
																	                  ...
																	                  <asp:label runat=server ID=lblAmountToSend CssClass=head09_13 Enabled=false>Bitcoins to Send</asp:label>  &nbsp;  <asp:TextBox ID="txtBitcoin" Width=100 runat="server" Enabled=false></asp:TextBox> =  &nbsp;<asp:label runat=server ID=lblPlan CssClass=head09_13></asp:label>
																	            ...
																	            <tr> 
																	                <td class=head09_13>
																	                Send the BTC amount to this address
																	                </td>
																	            </tr>
																	            
																	              <tr> 
																	                <td align=center>
																	               <asp:TextBox runat=server ID=txtBitcoinAddress Width=300 CssClass=BlueText Enabled=false>16Vj2rW2Su9xxBATkcmPDzXvcsmahdWvpR</asp:TextBox>
																	                </td>
																	            </tr>
																	                ...
																	                <td class=head09 align=center>
																	                           ...
																	                           <table border=0 align=center>
																	                            <tr> 
																	                                    ...
																	                                    <td valign=top width=10 height=10 align=center><asp:Image ID="Image1" ToolTip="Be sure you send the correct BTC amount to the correct address from your wallet. After you make the BTC payment please click the below button, [I did the payment], so we process your payment manually. Bitcoin Payment took usually from several minutes to 2 hours max to appear in your Deposit account" imageUrl ="picture/exclamation.jpg" runat=server  />
																	                                    </td>
																	                             </tr>
																	             ...
																	             <tr> 
																	                <td align=center class=RednormalText>
																	                    After you send the bitcoin payment from your wallet please click the below button [I did the payment] so we process your payment directly
																	                </td>
																	            </tr>
																	             <tr> 
																	                <td align=center class=RednormalText>
																	                    After we receive the payment, it will appear in your account, after that you can begin lending or exchanging
																	                </td>
																	            </tr>
																	            ...
																	            <tr> 
																	                ...
																	                <asp:Button id="btnPaid" runat="server" Text="I did the payment" Width="150px" Height=43 CssClass="INPUTBUTTON"></asp:Button>
																	                </td>
																	            </tr>
																	          </table>
