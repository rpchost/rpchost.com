...
#End Region
        ...
        Sub BindGrid()
            Dim cnn As New rpchost.cs_Connection

            Dim da As New OleDbDataAdapter("select ID,FirstName,LastName,Email,Country,city,HearAboutUs,Pwd,UsrName,isMember,Status,DateLastPayment,FirstLoginDate,LastLoginDate from MembersForex order by ID DESC", cnn.conn)
        ...
        Private Sub DataGrid1_EditCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid1.EditCommand
            ...
            'Response.Write("alert('e = " & e.Item.Cells(0).Text & " ')")
            'Response.Write("window.open('EditUsers.aspx?ID=" & e.Item.Cells(0).Text & " ','CustomPopUp','width=700, height=450, menubar=no, resizable=no,scroller=yes,left=200,top=150')")
            Response.Redirect("EditUsers.aspx?ID=" & e.Item.Cells(0).Text)
        ...
        Private Sub DataGrid1_UpdateCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid1.UpdateCommand
            ...
            cnn.Open()
            Dim cmd As New OleDbCommand("Update News Set Description='" & t1.Text & "' Where [ID]=" & e.Item.Cells(0).Text, cnn)
            cmd.ExecuteNonQuery()
            cnn.Close()
            DataGrid1.EditItemIndex = -1
            DataGrid1.ShowFooter = True
        ...
        Private Sub DataGrid1_DeleteCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid1.DeleteCommand
            ...
            Dim cnn As New OleDbConnection(connstr)
            cnn.Open()
            Dim cmd As New OleDbCommand("Delete From MembersForex Where [ID]=" & e.Item.Cells(0).Text, cnn)
            cmd.ExecuteNonQuery()
            cnn.Close()
            'DataGrid1.EditItemIndex = -1
