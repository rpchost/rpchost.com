<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BankTransfers.aspx.vb" Inherits="BankTransfers" %>
																	  ...
																	  <table width="100%">
																	   ...
																	   <tr>
																	          <td class="head05" width="100%" align=center>
        																	          ...
        																	          DEPOSIT WITH A BANK TRANSFER </TD>
																	                    ...
																	                    <tr> 
																	                         <td>
																	                                    ...
																	                                    <td align=center class=head06_small>
																	                                        ...
																	                                        <asp:TextBox runat=server ID=txtUserID Visible=true  CssClass=INPUTTEXT_CENTER Width=1 ></asp:TextBox>   
																	                                    </td>
																	                       ...
																	                       <table>
																	                        ...
																	                        <td  class="blacktextbold" width=100>
																	                         ...
																	                         <td class="blacknormaltext">
																	                            ...
																	                            <asp:Label runat=server ID=txtDepositAmount enabled=false Width=120 MaxLength=10 ></asp:Label> 
																	                       ...
																	                       <%-- <tr>
																	                        ...
																	                        <td class="blacktextbold">
																	                         ...
																	                         <td class="blacknormaltext">
																	                            ...
																	                            <asp:Label runat=server ID=lblIBAN ></asp:Label>
																	                     ...
																	                     <tr>
																	                        <td  class="blacktextbold">
																	                         ...
																	                         <td class="blacknormaltext">
																	                            ...
																	                            <asp:Label runat=server ID=lblBIC ></asp:Label>
...
<span class=rednormaltext> The invoice will be canceled after 1 hour <br> The invoice takes minutes to arrive<br> Please check your inbox and junk email </span>
																	       ...
																	       <tr> 
																	                <td  height=90 align=center class="rednormaltext">
																	                
																	                 				We accept third party bank transfers (REVOLUT, TRANSFERWISE, WORLDREMIT , ..)<br>
																	                 				
																	                 				<%--We advise making payments with <a href="http://worldremit.com">WorldRemit</a><br>--%>
																	                 				
																	                 						Click "Reserve transaction" button only if you will make the transfer<br> The transaction will stay alive for few days	<br>
																	                 						
																	                 						<b>IMPORTANT:</b> You MUST include the above MESSAGE number in the bank deposit message in order to credit your Rpchost account									                
