<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FreeSignal.aspx.vb" Inherits="FreeSignal" %>
...
<body onkeydown="DisableF5()" onkeypress="DisableF5()" onload="DisableF5()">
    ...
    <div >
    <%-- I am trading now with ZULUTRADE please meet me there and follow my signals, and have a look on my super 
            strategy.
            <br>
<br>            <a href="https://www.zulutrade.com/trader/290665" onclick="window.open(this.href, 'mypopup'); return false;">FOLLOW MY SIGNALS</a>--%>
 ...
 <%--  <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [ID],[OrderID], [Signal], [Status], [dtDateSignal],[dtDateClose], [Entry], [SL], [Target], [Comments],[profit] FROM [Signal] where year(dtDateSignal) = year(now) and month(dtDateSignal) = month(now)  order by dtDateSignal DESC
">
