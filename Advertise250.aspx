<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Advertise250.aspx.vb" Inherits="Advertise250" %>
				...
				<TR>
					...
					<TD vAlign="top" width="100%" height="100%">
						<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								<td height="20" Class="inputtextbtn">Process payment</td>
							</TR>
							<tr>
											...
											<td>
												<!-- Content goes here -->
													<TABLE WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="0">
														...
														<tr>
															<td class=BlackTextBold>You pay for this package $250 per MONTH, your banner will appear in the top 3 ranked rpchost.com web pages including home page. To process your order very quickly please put in the fields First name and Last name and email the information you eneterd in previous page. <span class="RednormalTextBold">Once you make the payment please send us an email to webmaster@rpchost.com including your banner [125*125] or ask us to make you a banner. And we will post it immediately in our website.</span></td>
														</tr>
														...
														<TR>
															<TD>
																<iframe src="http://www.shareit.com/product.html?productid=300324657" height="1400" width="800" scrolling="auto" frameborder="no"></iframe>
															</TD>
														</TR>
													</TABLE>
												<!-- End Content -->
