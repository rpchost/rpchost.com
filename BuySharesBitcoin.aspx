<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BuySharesBitcoin.aspx.vb" Inherits="BuySharesBitcoin" %>
																	  ...
																	  <table width="100%">
																	   ...
																	   <tr>
																	          <td class="head05" width="100%" align=center>
																	              ...
																	              <asp:Label CssClass="head05" ID=lblTitle width="100%" runat=server>BUY WITH CREDIT CARD [CONTRIBUTION MODE]</asp:Label>
															                  </TD>
																	      </tr>
																	          ...
																	          <td align=center>
																	           ...
																	           <tr> 
																	             ...
																	             <tr> 
																	              ...
																	              <tr> 
																	                <td align=center >
																	                   <asp:Label runat=server ID=lblAmountToPay cssclass=head06_small>Amount to contribute</asp:Label>
																	             ...
																	             <tr> 
																	               ...
																	               <tr> 
																	                <td height=50 class=RednormalText align=center>
																	                     ...
																	                     Please be sure of your Bitcoin address, wrong BTC addresses is not refundable.
                                                                                         <br />
                                                                                         EUR payments are without any extra fees. For USD payments a conversion to EUR fee is deducted by your 
                                                                                         bank<br>
																	                        This payment is canceled if you did not make the contribution and our 
                                                                                         contributors have reached the target. <br>Once you make the contribution we can 
                                                                                         not refund it.<br>
																	                        
																	                       
																	                        All the BTC shares will be paid to the shareholders once the contributions 
                                                                                         reached the target, ususally takes maximum 2 working days until the bitcoin 
                                                                                         reach your wallets.<br />
                                                                                         We use <u>papayoux-solidarite</u> services to help our clients to make the 
                                                                                         contributions<br />
                                                                                         We do not take any fees, only 1.9% fee is taken by papayoux-solidarite to process credit cards, it is included in your payment<br />
                                                                                         Please make sure you write your UserID in "Private message to the recipient"<br />
                                                                                         Please be sure you enter correct First Name and Last Name and Email exactly the 
                                                                                         same as Rpchost.com data<br />
                                                                                         <br><br>
																	            ...
																	            <tr> 
																	                ...
																	                <asp:Button id="btnSubmit" runat="server" Text="Contribute" Width="300px"  Height=43 CssClass="INPUTBUTTON" onclientclick="Redisplay()"></asp:Button>
																	                  
																	                <asp:Button id="btnCancelPayment" runat="server" Text="MAIN" Width="170px" Height=43 CssClass="INPUTBUTTON" onclientclick="Redisplay()"></asp:Button>
