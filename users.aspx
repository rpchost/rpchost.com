<%@ Page Language="vb" AutoEventWireup="false" Inherits="users" CodeFile="users.aspx.vb" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:datagrid id="DataGrid1" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 104px" runat="server"
				...
				<Columns>
					...
					<asp:TemplateColumn HeaderText="RegisterDate">
						<ItemTemplate>
							<asp:Label id="lblRegisterDate" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.RegisterDate") %>'>
							</asp:Label>
						</ItemTemplate>
						<FooterTemplate>
							<asp:TextBox id="txtRegisterDate" runat="server" Width="200px" Visible="False"></asp:TextBox>
						</FooterTemplate>
						<EditItemTemplate>
							<asp:TextBox id="txtRegisterDate8" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.RegisterDate") %>'>
							</asp:TextBox>
						</EditItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn HeaderText="PaypalEmail">
						<ItemTemplate>
							<asp:Label id="Label6" runat="server" Width="100px" Text='<%# DataBinder.Eval(Container, "DataItem.PaypalEmail") %>'>
							</asp:Label>
						</ItemTemplate>
						<FooterTemplate>
						...
						<EditItemTemplate>
							<asp:TextBox id="Textbox10" runat="server" Width="100px"  Text='<%# DataBinder.Eval(Container, "DataItem.PaypalEmail") %>'>
							</asp:TextBox>
						</EditItemTemplate>
					</asp:TemplateColumn>
					...
					<asp:TemplateColumn HeaderText="Pwd">
						<ItemTemplate>
							<asp:Label id="Label8" runat="server" Width="100px" Text='<%# DataBinder.Eval(Container, "DataItem.Pwd") %>'>
							</asp:Label>
						</ItemTemplate>
						<FooterTemplate>
						...
						<EditItemTemplate>
							<asp:TextBox id="Textbox14" runat="server" Width="100px" Text='<%# DataBinder.Eval(Container, "DataItem.Pwd") %>'>
							</asp:TextBox>
						</EditItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn HeaderText="UsrName">
						<ItemTemplate>
							<asp:Label id="Label9" runat="server" Width="20px" Text='<%# DataBinder.Eval(Container, "DataItem.UsrName") %>'>
							</asp:Label>
						</ItemTemplate>
						<FooterTemplate>
					...
					<asp:TemplateColumn HeaderText="Status">
						<ItemTemplate>
							<asp:Label id="Label10" runat="server" Width="20px" Text='<%# DataBinder.Eval(Container, "DataItem.Status") %>'>
							</asp:Label>
						</ItemTemplate>
						<FooterTemplate>
					...
					<asp:TemplateColumn HeaderText="BankName">
						<ItemTemplate>
							<asp:Label id="Label12" runat="server"  Text='<%# DataBinder.Eval(Container, "DataItem.BankName") %>'>
							</asp:Label>
						</ItemTemplate>
						<FooterTemplate>
						...
						<EditItemTemplate>
							<asp:TextBox id="Textbox22" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.BankName") %>'>
							</asp:TextBox>
						</EditItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn HeaderText="IBAN">
						<ItemTemplate>
							<asp:Label id="lblPayeer" runat="server"  Text='<%# DataBinder.Eval(Container, "DataItem.IBAN") %>'>
							</asp:Label>
						</ItemTemplate>
						<FooterTemplate>
						...
						<EditItemTemplate>
							<asp:TextBox id="Textbox24" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.IBAN") %>'>
							</asp:TextBox>
						</EditItemTemplate>
					</asp:TemplateColumn>
					
					
					<asp:TemplateColumn HeaderText="AccountNum">
						<ItemTemplate>
							<asp:Label id="lblBitcoinWallet" runat="server"  Text='<%# DataBinder.Eval(Container, "DataItem.AccountNum") %>'>
							</asp:Label>
						</ItemTemplate>
						<FooterTemplate>
						...
						<EditItemTemplate>
							<asp:TextBox id="Textbox26" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.AccountNum") %>'>
							</asp:TextBox>
						</EditItemTemplate>
					</asp:TemplateColumn>
					
					
					<asp:TemplateColumn HeaderText="BankCountry">
						<ItemTemplate>
							<asp:Label id="lblBankCountry" runat="server"  Text='<%# DataBinder.Eval(Container, "DataItem.BankCountry") %>'>
							</asp:Label>
						</ItemTemplate>
						<FooterTemplate>
							<asp:TextBox id="Textbox27" runat="server" Width="200px" Visible="False"></asp:TextBox>
						</FooterTemplate>
						<EditItemTemplate>
							<asp:TextBox id="TextBankCountry" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.BankCountry") %>'>
							</asp:TextBox>
						</EditItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn>
