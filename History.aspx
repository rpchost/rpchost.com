                                                                                     ...
                                                                                     <table border=0>
                                                                                       ...
                                                                                       <tr>
                                                                                        <td Class=head09>Investment ID</TD>
                                                                                         <td><asp:TextBox runat=server ID=txtInvestmentID Enabled=false CssClass=INPUTTEXT ></asp:TextBox></TD>
                                                                                       </tr>
                                                                                       
                                                                                       <tr>
                                                                                        <td width=250 Class=head09>User ID</TD>
                                                                                         <td width=200 ><asp:TextBox runat=server ID=txtUserID Enabled=false CssClass=INPUTTEXT></asp:TextBox></TD>
                                                                                       </tr>
                                                                                       
                                                                                        <tr>
                                                                                        <td Class=head09>Name </TD>
                                                                                         <td><asp:TextBox runat=server ID=txtUserName Enabled=false CssClass=INPUTTEXT></asp:TextBox></TD>
                                                                                       </tr>
                                                                                       
                                                                                      
                                                                                       
                                                                                         <tr>
                                                                                        <td Class=head09> Print Date </TD>
                                                                                         <td><asp:TextBox runat=server ID=txtDate Enabled=false CssClass=INPUTTEXT></asp:TextBox></TD>
                                                                                       </tr>
                                                                                                                 ...
                                                                                                                 <Columns>
                                                                                                                     ...
                                                                                                                     <asp:BoundField DataField="Capital" HeaderText="Balance" ItemStyle-HorizontalAlign=Center SortExpression="Capital" />
                                                                                                                         ...
                                                                                                                         SortExpression="Status" />
                                                                                                                          ...
                                                                                                                          <asp:BoundField DataField="PaymentType" HeaderText="Gate" ItemStyle-ForeColor="#336600"  ItemStyle-HorizontalAlign=Center
                                                                                                                         SortExpression="PaymentType" />
                                                                                                                         
                                                                                                                          <asp:BoundField DataField="PaymentPhase" HeaderText="Phase" ItemStyle-ForeColor="#336600"  ItemStyle-HorizontalAlign=Center
                                                                                                                         SortExpression="PaymentPhase" />
