<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PerformanceDetails.aspx.vb" Inherits="PerformanceDetails" %>
...
<body onkeydown="DisableF5()" onkeypress="DisableF5()" onload="DisableF5()">
   ...
   <%-- <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [ID], [Signal], [Status], [dtDateSignal],[dtDateClose], [Entry], [SL], [Target], [Comments],[profit] FROM [Signal] where year(dtDateSignal) = year(now) and month(dtDateSignal) = month(now) and isFreeSignal = yes  order by dtDateSignal DESC
">--%>
