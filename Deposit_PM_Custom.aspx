<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Deposit_PM_Custom.aspx.vb" Inherits="Deposit_PM_Custom" %>
...
<meta name="verify-admitad" content="2504a66eeb" />	
  ...
  <script>
	...
	<body leftMargin=0 topmargin=0 > 
								...
								<form id="Form1" action="https://perfectmoney.is/api/step1.asp" onsubmit="myFunction()" runat=server method="POST">
																	           ...
																	           <tr> 
																	              ...
																	              <tr> 
																	                <td align=center class=head07>
																	                     ...
																	                     <%--<asp:Label runat=server ID=lblPlan>Rpchost.com Custom Plan</asp:Label>  
																	                --%>
																	                </td>
																	            </tr>
																	              ...
																	              <tr> 
																	                <td align=center class=head07>
																	                     ...
																	                     <asp:label runat=server id=lblAmountCurr cssclass=head07></asp:label>  Amount To Deposit</td>
																	            </tr>
																	            
																	              <tr> 
																	                <td align=center class=head07>
																	                
																	                    <asp:TextBox runat=server ID=txtDepositAmount enabled=false CssClass=INPUTTEXT_CENTER Width=120 ></asp:TextBox>
																	            ...
																	            <tr> 
																	                <td align=center>
																	                    ...
																	                    <input type="hidden" name="PAYEE_ACCOUNT" value="U14470920">
                                                                                        <input type="hidden" name="PAYEE_NAME" value="Rpchost.com">
                                                                                        <input type="hidden" name="PAYMENT_ID"  value="Rpchost.com PerfectMoney payment - <%= Session("UserID")%> " >                                                                                      
                                                                                        <input type="hidden" name="PAYMENT_AMOUNT" value="<%= Session("AmountUSD")%>" />
                                                                                        <input type="hidden" name="PAYMENT_UNITS" value="<%= Session("Currency")%>">
                                                                                        <input type="hidden" name="STATUS_URL" value="lanamonyuk@gmail.com">
                                                                                        <input type="hidden" name="PAYMENT_URL" value="http://www.rpchost.com/ReservePayment.aspx?type=4">
                                                                                        <input type="hidden" name="PAYMENT_URL_METHOD" value="LINK">
                                                                                        <input type="hidden" name="NOPAYMENT_URL" value="http://www.rpchost.com/Login.aspx?redirect=BuyBitcoin">
                                                                                        <input type="hidden" name="NOPAYMENT_URL_METHOD" value="LINK">
                                                                                        <input type="hidden" name="SUGGESTED_MEMO" value="Rpchost.com PerfectMoney payment; UserID - <%= Session("UserID")%> - Amount - <%= Session("AmountUSD")%> - Currency - <%= Session("Currency")%> - BTC - <%= Session("AmountBTC")%> ">
                                                                                        <input type="hidden" name="BAGGAGE_FIELDS" value="">
                                                                                       
                                                                                        <%--<input type="submit" name="PAYMENT_METHOD" width=100 height=100  value="Pay Now!">--%>
																	                <asp:Button id="btnSubmit" runat="server" Text="Make the Deposit" Width="150px" Height=43 CssClass="INPUTBUTTON"></asp:Button>
																	                </td>
																	            </tr>
																	          </table>
