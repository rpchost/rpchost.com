...
#Region "Returning Reader from SQL Routines"
        Public Function rdGetReaderInspection(ByVal strSQL As String) As SqlDataReader
...
#Region "Execute Sql Operation (Insert , Update)"
        Public Function ExecuteSql(ByVal StrSql As String) As Boolean
            ...
            Try
                ...
                sqlComm.CommandTimeout = 1000000
...
#Region "Returning Reader from SQL Routines"
        Public Function rdGetReader(ByVal strSQL As String) As SqlDataReader
...
#End Region
        ...
        Public Function ExecuteScalaredSql(ByVal StrSql As String) As String
            ...
            'Start a local transaction.
            Dim myTrans As SqlTransaction = sqlConn.BeginTransaction()
...
#Region "Returning Reader from SQL Routines"
        Public Function rdGetReaderSync(ByVal strSQL As String) As SqlDataReader
...
#Region "Execute (Select) Stored Procedure ... Return Value : DataReader"
        Public Function ExecuteStoredProcedureDR(ByVal strProcedureName As String, ByVal strParamName As String(), ByVal strParamValue As String()) As SqlDataReader
            ...
            Do While i < strParamName.Length() - 1
                'Set sqlParameter Properties
                sqlParam = New SqlParameter(strParamName(i), strParamValue(i))
                sqlComm.Parameters.Add(sqlParam)
                i = i + 1
            Loop
...
#Region "Execute (Select) Stored Procedure ... Return Value : DataReader"
        Public Function ExecuteSP_DR(ByVal strProcedureName As String, ByVal strSql As String) As SqlDataReader
