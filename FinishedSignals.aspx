<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FinishedSignals.aspx.vb" Inherits="FinishedSignals" %>
...
<body onkeydown="DisableF5()" onkeypress="DisableF5()" onload="DisableF5()">
    ...
    <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [ID],[OrderID], [Signal], [Status], [dtDateSignal],[dtDateClose], [Entry], [SL], [Target], [Comments],[profit] FROM [Signal] where Status='C' order by dtDateSignal DESC
">
