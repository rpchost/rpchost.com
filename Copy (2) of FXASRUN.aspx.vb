...
Public Class FXASRUN
    ...
    Public Const strLocation As String = "C:\Users\joseph.chalhoub\AppData\Roaming\MetaQuotes\Terminal\582F1420F7EA955F22B2F71E2A1B68A0\MQL4\Files"
    ...
    Sub EURUSD()
        ...
        Try
            ...
            str_Renamed = Text2String(strLocation + "\BuySellEU.txt")
            ...
            If UBound(arr) - LBound(arr) + 1 = 5 Then
                ...
                If (strDirection = "Long") Then UpdateIndicatorUsers("B", "EURUSD")
                If (strDirection = "Short") Then UpdateIndicatorUsers("S", "EURUSD")
    ...
    Sub GBPUSD()
        ...
        strSignal = Text2String(strLocation + "\SignalsGS.txt")
        ...
        str_Renamed = Text2String(strLocation + "\BuySellGS.txt")
        ...
        If UBound(arr) - LBound(arr) + 1 = 5 Then
            ...
            If (strDirection = "Long") Then UpdateIndicatorUsers("B", "GBPUSD")
            If (strDirection = "Short") Then UpdateIndicatorUsers("S", "GBPUSD")
    ...
    Sub EURJPY()
        ...
        Try
            ...
            strSignal = Text2String("C:\Program Files (x86)\GCI MT4\experts\files\SignalsEJ.txt")
            ...
            str_Renamed = Text2String("C:\Program Files (x86)\GCI MT4\experts\files\BuySellEJ.txt")
    ...
    Sub USDJPY()
        ...
        Try
            ...
            str_Renamed = Text2String(strLocation + "\BuySellUJ.txt")
            ...
            If (str_Renamed.Trim = "Buy") Then
                ...
                JPYImg.DataBind()
                UpdateIndicatorUsers("B", "USDJPY")
            End If
            If (str_Renamed.Trim = "Sell") Then
                JPYImg.ImageUrl = "picture\down.gif"
                JPYImg.UpdateAfterCallBack = True
                JPYImg.DataBind()
                UpdateIndicatorUsers("S", "USDJPY")
            End If
            If (str_Renamed.Trim = "") Then
                JPYImg.ImageUrl = "picture\flat.gif"
                JPYImg.UpdateAfterCallBack = True
                JPYImg.DataBind()
                UpdateIndicatorUsers("", "USDJPY")
            End If
            ...
            If UBound(arr) - LBound(arr) + 1 = 5 Then
                ...
                If (InStr(1, str_Renamed, "Buy", CompareMethod.Text) > 0) Or (InStr(1, str_Renamed, "Sell", CompareMethod.Text) > 0) Then
                    ...
                    If ((strDirection = "Long" And isTradeExist("B", "USD/JPY") = False) Or (strDirection = "Short" And isTradeExist("S", "USD/JPY") = False)) Then
                        ...
                        If (strDirection = "Long") Then UpdateIndicatorUsers("B", "USDJPY")
                        If (strDirection = "Short") Then UpdateIndicatorUsers("S", "USDJPY")
    ...
    Private Function UpdateIndicatorUsers(ByVal BuySell As String, ByVal Currency As String) As Boolean
        ...
        Dim indicator As New com.rpchost.www.grabdataSQL
        indicator.Proxy = wprxStock

        Return indicator.UpdateIndicatorUsers(BuySell, Currency)
        indicator.Dispose()
...
ErrTrap:
    ...
    Private Sub clearFileGU()
        ...
        Try
            ...
            FileOpen(iFileNo, strLocation + "\SignalsGS.txt", OpenMode.Output) 'please note, if this file already exists it will be overwritten!       'write some example text to the file  Print #iFileNo, "first line of text"  Print #iFileNo, "   second line of text"
