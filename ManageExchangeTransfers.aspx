<%@ Page Language="VB" Theme="theme" AutoEventWireup="false" CodeFile="ManageExchangeTransfers.aspx.vb" Inherits="ManageExchangeTransfers" %>
...
<body>
                    ...
                    <tr>
                        <td>
                          ...
                          <td>
                           ...
                           <asp:ListItem Value=UsdExchange>USD Exchanging Transfers</asp:ListItem>
                           <asp:ListItem Value=BtcExchange>BTC Exchanging Transfers</asp:ListItem>
                           </asp:CheckBoxList>
    ...
    <tr>
        <td>
              ...
              <asp:GridView ID="grdExchangeTransfers" runat="server" SkinID=grdFxas AutoGenerateColumns="False" 
                         DataKeyNames="ID" onrowupdating="grdExchangeTransfers_RowUpdating" DataSourceID="AccessDataSource1" Width=800>
                         <Columns>
                            ...
                            <asp:TemplateField HeaderText="ID">
                              ...
                              <asp:TemplateField HeaderText="UsdTransfer">
                                <ItemTemplate>
                                    <asp:Label ID="UsdTransfer" runat="server" Text='<%# Bind("UsdTransfer") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="UsdTransfer" runat="server" Text='<%# Bind("UsdTransfer") %>'></asp:TextBox>
                                </EditItemTemplate>
                            </asp:TemplateField>
                                 
                                 
                                 <asp:TemplateField HeaderText="BtcTransfer">
                                <ItemTemplate>
                                    <asp:Label ID="BtcTransfer" runat="server" Text='<%# Bind("BtcTransfer") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="BtcTransfer" runat="server" Text='<%# Bind("BtcTransfer") %>'></asp:TextBox>
                                </EditItemTemplate>
                            </asp:TemplateField>
                        ...
                        <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
                         DataFile="~/DB/db_maindata.mdb" SelectCommand="SELECT * FROM [ExchangeTransferRequest] " UpdateCommand="update ExchangeTransferRequest set test=? where ID=?" DeleteCommand="delete from ExchangeTransferRequest where ID=?"  >
