<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FXASRUNZULUTRADE.aspx.vb" Inherits="FXASRUNZULUTRADE" %>
...
<body topmargin=0 >
       ...
       <tr>
            ...
            <td colspan=7 >
              <asp:Button ID="cmdSync" Width =100%  CssClass="INPUTBUTTONNew" runat="server" Text="Synchronize" />
                   ...
                   <tr>
            <td colspan=7 >
              <asp:Button ID="Button3" Width =100%  CssClass="INPUTBUTTONNew" runat="server" Text="Show Signals providers" />
</td>
                 </tr>
    ...
    <table width = 100% bgcolor=gray>
       ...
       <tr>
            ...
            <td>
                    ...
                    <anthem:TextBox ID="txtRpcPwd" CssClass="inputtext" Width=60  runat="server" TextMode="Password" >jijo1136</anthem:TextBox>
            </td>
        ...
        <tr>
            ...
            <td>
                            <anthem:TextBox ID="txtUserName" CssClass="inputtext" Width=100 runat="server">D102766611001</anthem:TextBox>
         ...
         <tr>
            ...
            <td> 
                            <anthem:TextBox ID="txtPassword" EnableViewState=true CssClass="inputtext" Width=100 
                                runat="server" TextMode=Password >7649</anthem:TextBox>
 ...
 <tr>
    ...
    <tr>
        ...
        <anthem:Label ID=lblMess CssClass="MaroonText" Font-Bold=true Width=450 runat=server ></anthem:Label>
...
--%>
    ...
    <tr>
        ...
        <td colspan=4>
         ...
         <anthem:Timer ID="Timer1" Enabled="true" Interval=900000 runat="server"/>
