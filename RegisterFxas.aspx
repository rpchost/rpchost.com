<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RegisterFxas.aspx.vb" Inherits="RegisterFxas" %>
											...
											<td>
												<!-- Content goes here -->
													<TABLE WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="0">
														...
														<tr>
															<td class=BlackTextBold> FXAS MOBILE ANDROID APPLICATION IS A MOBILE APPLCATION RUNNING ON ANDROID MOBILES AND ALLOWING USERS TO GET SIGNALS 
															INSTANTLY FROM RPCHOST.COM WITH SOUND ALERTS, AND DAILY ANALYSIS OF THE FOREX MARKET. FXAS IS A COMPLETE PLATFORM HELPING USERS TO MAKE RIGHT DECISIONS.
															
															<font face=ARIAL color=red>GET IT FOR $75 / YEAR.</font>
														...
														<TR>
															<TD>
																<iframe src="http://www.shareit.com/product.html?cart=1&productid=300614914" height="1400" width="800" scrolling="auto" frameborder="no"></iframe>
															</TD>
														</TR>
													</TABLE>
												<!-- End Content -->
