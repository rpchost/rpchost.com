...
#End Region
    ...
    Sub BindGrid()
        ...
        Dim da As New OleDbDataAdapter("select ID,dtDate,SqwakText,DateNow,statements,TextStatement from SqwakBox where year(dtDate) = year(now) and Month(dtDate)=Month(Now)  order by dtDate DESC", cnn)
