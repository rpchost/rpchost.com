<%@ Page Language="VB" AutoEventWireup="false" CodeFile="OfferPayment.aspx.vb" Inherits="OfferPayment" %>
      ...
      transactions: [
        {
          ...
          description: document.getElementById('<%= txtBtcAmount.ClientID %>').value + " BTC.  " +  " Wallet =  " + document.getElementById('<%= txtBtcAddress.ClientID %>').value + ". UserID = " + document.getElementById('<%= txtUserID.ClientID %>').value + ". OfferID = " + document.getElementById('<%= txtOfferID.ClientID %>').value
        }
      ]
    }
  });
...
onAuthorize: function (data, actions) {
  ...
  window.location.replace('ReserveOffer.aspx');
												...
												<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
													<TR>
														<td Width="100%" Class="inputtitletext" valign=middle Height="25">
																		<!-- Content goes here -->
																		<div class=head09 >SELL BITCOIN</div>
																	   ...
																	   <tr>
																	                ...
																	                <td align=left >
																	                    ...
																	                    <tr> 
																	                     ...
																	                     <td align=center class=head06_small>
																	                             ...
																	                             <asp:Label runat=server ID=lblOfferID Width=70>Offer ID</asp:Label>
																	                                        <br><br>    
																	                                	<asp:TextBox runat=server ID=txtOfferID Visible=true enabled=false CssClass=INPUTTEXT Width=80 ></asp:TextBox> 																                                
																	                        </td>
																	      ...
																	      <tr> 
																	         ...
																	         <tr> 
																	                ...
																	                <a href=Transactions.aspx class="inputbutton" width=150>&nbsp; Back &nbsp;</a>
