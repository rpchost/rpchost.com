...
Partial Class Deposit
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        txtMonthlyProfit.Text = "Be your own bank" 'rate.GetInterestRate() & " % Monthly Profit"
    ...
    Protected Sub btnDepositWU_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDepositWU.Click
        Response.Redirect("Deposit_WU.aspx")
    End Sub

    Protected Sub btnDepositBank_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDepositBank.Click
