<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Deposit_Credit_Detail.aspx.vb" Inherits="Deposit_Credit_Detail" %>
												...
												<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
													<TR>
														<td Width="100%" Class="inputtitletext" valign=middle Height="25">
																		<!-- Content goes here -->
																		<div class=head09 >CUSTOM CREDIT CARD DEPOSIT</div>
																	          ...
																	          <td align=center>
																	              ...
																	              <tr> 
																	                <td align=center class=head07>
																	                 ...
																	                 <asp:Label runat=server ID=lblPaymentRequest></asp:Label>   <br>
																	               ...
																	               <tr> 
																	                <td height=70 class=RednormalText align=center>
																	              
																	                        
																	                        We send payment request directly to customers email for security purposes.<br><br> 
                                                                                            Our payment gateway is payoneer.com The most reliable and secure payment gateway 
                                                                                            online <br><br>
																	                        
																	                        Once you click the payment request, you can either login to your payoneer account [if you have a payoneer account] <br><br> 
                                                                                            Or 
																	                        
																	                        click the button [pay as a guest] and it will redirect you to the credit card payment page.<br><br>
																	                        
																	                        We have set the Due Date for 1 day, after 1 day, the link is disabled<br><br>
																	                        
																	                        Minimum amount to send is 20 USD
																	            ...
																	            <tr> 
																	                <td align=center>
                                                                                        ...
                                                                                        <input type="hidden" name="PAYMENT_ID"  value="Rpchost.com Custom Plan - <%= Session("UserID")%> " >
                                                                                        
                                                                                       
                                                                                        <input type="hidden" name="PAYMENT_AMOUNT" id="someid" />
                                                                                       
                                                                                        <input type="hidden" name="PAYMENT_UNITS" value="USD">
                                                                                        <input type="hidden" name="STATUS_URL" value="rpchost@hotmail.com">
                                                                                        <input type="hidden" name="PAYMENT_URL" value="http://www.rpchost.com">
                                                                                        <input type="hidden" name="PAYMENT_URL_METHOD" value="LINK">
                                                                                        <input type="hidden" name="NOPAYMENT_URL" value="http://www.rpchost.com">
