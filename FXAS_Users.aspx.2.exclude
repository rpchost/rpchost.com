<%@ Page Theme="theme" Language="VB" AutoEventWireup="false" CodeFile="FXAS_Users.aspx.vb" Inherits="FXAS_Users" %>
   ...
   <table border=0 topmargin=0>
         ...
         <tr>        
          ...
          <td>
           ...
           <td></td>
          <td><anthem:Button ID="Button3" CausesValidation=false Text="BUY" AutoUpdateAfterCallBack=true CssClass="INPUTBUTTONNew" runat="server" /> </td>
          <td><anthem:Button ID="Button4" CausesValidation=false  Text="SELL" AutoUpdateAfterCallBack=true CssClass="INPUTBUTTONNew" runat="server" /></td> 
    ...
    <table width = 100% bgcolor=gray>
       ...
       <tr>
            <td colspan=5 Class="BlueText" >
                RPCHOST.COM USERID AND PWD&nbsp;&nbsp; <a href=RegisterContent.aspx class="MaroonSmallText8" target=new>Not a member? .. Register</a>
            </td>
            ...
            <td>
                            <anthem:TextBox ID="txtRpcUserID" CssClass="inputtext" Width=50 runat="server"></anthem:TextBox>
          ...
          <tr>
            <td colspan=4 Class="BlueText" height=40>
                FXCM USERID AND PWD &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <a href="http://www.fxcmmena.com/en/open-a-demo-account" target= new class="MaroonSmallText8">Create 
                Demo account</a>
            </td>
        ...
        <tr>
            ...
            <td>
                            <anthem:TextBox ID="txtUserName" CssClass="inputtext" Width=100 runat="server"></anthem:TextBox>
