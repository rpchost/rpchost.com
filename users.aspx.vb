...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim connect As New rpchost.cs_Connection
    ...
    Sub BindGrid()
        ...
        Dim da As New OleDbDataAdapter("select * from MembersForex order by ID desc", cnn.conn)
    ...
    Private Sub DataGrid1_UpdateCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid1.UpdateCommand
        ...
        Dim cnn As New rpchost.cs_Connection
        cnn.openConnection()
        Dim cmd As New OleDbCommand("Update News Set Description='" & t1.Text & "' Where [ID]=" & e.Item.Cells(0).Text, cnn.sqlConn)
        cmd.ExecuteNonQuery()
        cnn.closeConnection()
        DataGrid1.EditItemIndex = -1
        DataGrid1.ShowFooter = True
    ...
    Private Sub DataGrid1_DeleteCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid1.DeleteCommand
        ...
        Dim cnn As New rpchost.cs_Connection
        cnn.openConnection()
        Dim cmd As New OleDbCommand("Delete From MembersForex Where [ID]=" & e.Item.Cells(0).Text, cnn.sqlConn)
        cmd.ExecuteNonQuery()
        cnn.closeConnection()
        'DataGrid1.EditItemIndex = -1
